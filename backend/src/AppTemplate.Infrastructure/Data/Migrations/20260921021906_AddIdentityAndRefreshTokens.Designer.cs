...
namespace AppTemplate.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260921021906_AddIdentityAndRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppTemplate.Infrastructure.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AppTemplate.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AppTemplate.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.HasOne("AppTemplate.Infrastructure.Identity.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AppTemplate.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
